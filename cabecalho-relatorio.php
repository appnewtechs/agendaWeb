...
<head>
    ...
    <link href='<?php echo $base_url; ?>/js/fullcalendar/fullcalendar.print.min.css' rel='stylesheet' media='print' />
...
<script src="<?php echo $base_url; ?>/js/autosize.min.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo $base_url; ?>/table/css/fixedheadertable.css"> 
    <link rel="stylesheet" type="text/css" href="<?php echo $base_url; ?>/table/css/custom.css"> 
    <script src="<?php echo $base_url; ?>/table/js/jquery.fixedheadertable.js"></script>
<!--
