<?php 
	...
	// }else{
	// 	$_SESSION["danger"] = "Cliente não cadastrado. Razão Social ou Nome fantasia Já utilizado!";
	// 	header("Location: cliente.php");
	// 	die();		
	// }
