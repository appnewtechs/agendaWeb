<?php 
    ...
    session_start();
    // if(buscaNomeFantasiaRazaoSocial($conexao,$cnpj,$nome_fantasia,$razao_social,$id_cliente)==null){
    ...
    // }else{
    //     $_SESSION["danger"] = "Cliente não atualizado. Razão Social ou Nome fantasia Já utilizado!";
    //     header("Location: cliente.php");
    //     die();      
    // }
