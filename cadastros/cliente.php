                                        ...
                                        <div class="tab-content">
                                            <div id="menu1-<?php echo $cliente['id_cliente']; ?>" class="tab-pane fade in active">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label class="col-form-label required">Prestador de Serv.</label>
                                                        <select name="prestador_servico" class="custom-select form-control" required="true">
                                                            <option <?php if ($cliente['prestador_servico'] == "1") {
																		echo "selected";
																	} ?> value='1'>Sim</option>
                                                            <option <?php if ($cliente['prestador_servico'] == "0") {
																		echo "selected";
																	} ?> value='0'>Não</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label class="col-form-label">Estado</label>
                                                        <select name="estado" class="custom-select form-control">
                                                            <option <?php if ($cliente['estado'] == "AC") {
																		echo "selected";
																	} ?> value="AC">Acre</option>
                                                            <option <?php if ($cliente['estado'] == "AL") {
																		echo "selected";
																	} ?> value="AL">Alagoas</option>
                                                            <option <?php if ($cliente['estado'] == "AP") {
																		echo "selected";
																	} ?> value="AP">Amapá</option>
                                                            <option <?php if ($cliente['estado'] == "AM") {
																		echo "selected";
																	} ?> value="AM">Amazonas</option>
                                                            <option <?php if ($cliente['estado'] == "BA") {
																		echo "selected";
																	} ?> value="BA">Bahia</option>
                                                            <option <?php if ($cliente['estado'] == "CE") {
																		echo "selected";
																	} ?> value="CE">Ceará</option>
                                                            <option <?php if ($cliente['estado'] == "DF") {
																		echo "selected";
																	} ?> value="DF">Distrito Federal</option>
                                                            <option <?php if ($cliente['estado'] == "ES") {
																		echo "selected";
																	} ?> value="ES">Espirito Santo</option>
                                                            <option <?php if ($cliente['estado'] == "GO") {
																		echo "selected";
																	} ?> value="GO">Goiás</option>
                                                            <option <?php if ($cliente['estado'] == "MA") {
																		echo "selected";
																	} ?> value="MA">Maranhão</option>
                                                            <option <?php if ($cliente['estado'] == "MS") {
																		echo "selected";
																	} ?> value="MS">Mato Grosso do Sul</option>
                                                            <option <?php if ($cliente['estado'] == "MT") {
																		echo "selected";
																	} ?> value="MT">Mato Grosso</option>
                                                            <option <?php if ($cliente['estado'] == "MG") {
																		echo "selected";
																	} ?> value="MG">Minas Gerais</option>
                                                            <option <?php if ($cliente['estado'] == "PA") {
																		echo "selected";
																	} ?> value="PA">Pará</option>
                                                            <option <?php if ($cliente['estado'] == "PB") {
																		echo "selected";
																	} ?> value="PB">Paraíba</option>
                                                            <option <?php if ($cliente['estado'] == "PR") {
																		echo "selected";
																	} ?> value="PR">Paraná</option>
                                                            <option <?php if ($cliente['estado'] == "PE") {
																		echo "selected";
																	} ?> value="PE">Pernambuco</option>
                                                            <option <?php if ($cliente['estado'] == "PI") {
																		echo "selected";
																	} ?> value="PI">Piauí</option>
                                                            <option <?php if ($cliente['estado'] == "RJ") {
																		echo "selected";
																	} ?> value="RJ">Rio de Janeiro</option>
                                                            <option <?php if ($cliente['estado'] == "RN") {
																		echo "selected";
																	} ?> value="RN">Rio Grande do Norte</option>
                                                            <option <?php if ($cliente['estado'] == "RS") {
																		echo "selected";
																	} ?> value="RS">Rio Grande do Sul</option>
                                                            <option <?php if ($cliente['estado'] == "RO") {
																		echo "selected";
																	} ?> value="RO">Rondônia</option>
                                                            <option <?php if ($cliente['estado'] == "RR") {
																		echo "selected";
																	} ?> value="RR">Roraima</option>
                                                            <option <?php if ($cliente['estado'] == "SC") {
																		echo "selected";
																	} ?> value="SC">Santa Catarina</option>
                                                            <option <?php if ($cliente['estado'] == "SP") {
																		echo "selected";
																	} ?> value="SP">São Paulo</option>
                                                            <option <?php if ($cliente['estado'] == "SE") {
																		echo "selected";
																	} ?> value="SE">Sergipe</option>
                                                            <option <?php if ($cliente['estado'] == "TO") {
																		echo "selected";
                                            ...
                                            <div id="menu3-<?php echo $cliente['id_cliente']; ?>" class="tab-pane fade">
                                                <table class="table table-hover">
													...
													?>
                                                        <tr>
                                                            <td>Este cliente não possui nenhum contato</td>
                                                        </tr>
                                                        <?php	
													}
													?>
