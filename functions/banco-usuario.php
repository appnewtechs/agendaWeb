...
function insereUsuario($conexao, $login, $senha, $nome, $data_nascimento, $email, $telefone, $perfis, $cor, $imagem, $id_linha_produto, $id_empresa, $especialidade, $status){
	$senhaMd5 = md5($senha);
	...
	$query = "insert into usuario(login, senha, nome, data_nascimento, email, telefone, cor, imagem, id_linha_produto, id_empresa, especialidade, status) values('{$login}','{$senhaMd5}','{$nome}',{$data_nascimento},'{$email}', '{$telefone}', '{$cor}', '{$imagem}', '{$id_linha_produto}', '{$id_empresa}', '{$especialidade}', '{$status}')";
